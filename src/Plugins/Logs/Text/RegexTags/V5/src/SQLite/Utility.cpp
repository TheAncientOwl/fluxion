...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::Utility);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::Utility);

namespace Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::Utility {
...
[[nodiscard]] std::vector<std::string> MakeFieldsIDs(
    std::vector<Fluxion::API::LogsPlugin::ColumnDetails> const& columns)
{
