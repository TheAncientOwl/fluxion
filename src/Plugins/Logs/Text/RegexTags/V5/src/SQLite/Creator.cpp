...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::Creator);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::Creator);
...
bool Creator::CreateTables(std::span<std::string const> const fields_ids)
{
