...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::BufferedFilteredLogsWriter);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V5::SQLite::BufferedFilteredLogsWriter);
