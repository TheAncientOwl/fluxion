...
FLUXION_REGISTER_LOGS_PLUGIN(Fluxion::Plugins::Logs::Text::RegexTags::V3::RegexTags);
...
{
    return new Fluxion::Plugins::Logs::Text::RegexTags::V3::RegexTags();
}
