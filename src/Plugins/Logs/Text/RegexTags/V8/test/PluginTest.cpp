...
/// @version 8.1
/// @brief Logs::Text::RegexTags::V8 Google Test Suite
///
...
class Text_RegexTags_V8_LogsPluginWrapper : public ILogsPluginTestWrapper
{
public:
    /**
    ...
    void Setup(std::filesystem::path const& plugin_home_path) final override
    {
...

        {
            ...
            std::vector<Fluxion::Plugins::Logs::Text::RegexTags::V8::Data::RegexTag> tags{};
            {
...
private:
    Fluxion::Plugins::Logs::Text::RegexTags::V8::RegexTags m_plugin{};
    std::filesystem::path m_home_path{};
    std::ofstream m_raw_logs_file{};
};

FLUXION_DEFINE_LOGS_PLUGIN_TESTS(Text_RegexTags_V8_LogsPluginWrapper, {.logs_count = 2000, .seed = 69420});
