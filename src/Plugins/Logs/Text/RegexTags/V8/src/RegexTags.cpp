...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V8::RegexTags);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V8::RegexTags);

FLUXION_REGISTER_LOGS_PLUGIN(Fluxion::Plugins::Logs::Text::RegexTags::V8::RegexTags);
...
{
    return new Fluxion::Plugins::Logs::Text::RegexTags::V8::RegexTags();
}
