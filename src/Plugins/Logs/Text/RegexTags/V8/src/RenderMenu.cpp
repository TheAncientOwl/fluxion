...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V8::RenderMenu);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V8::RenderMenu);
    ...
    if (ImGui::CollapsingHeader("Import Settings", ImGuiTreeNodeFlags_DefaultOpen))
    {
        if (ImGui::BeginTable("##ImportSettingsTable", 3, ImGuiTableFlags_SizingFixedFit))
        {
            ...
            render_input(
                ...
                s_default_config.import_params.file_slice_size_mb * 100,
                s_default_config.import_params.file_slice_size_mb,
                "import",
                "file_slice_size_mb");
            render_input(
                "File target slice (MB)",
                "##filetargetslice",
                m_settings.import_params.file_target_slice_mb,
                s_default_config.import_params.file_target_slice_mb * 100,
                s_default_config.import_params.file_target_slice_mb,
                "import",
