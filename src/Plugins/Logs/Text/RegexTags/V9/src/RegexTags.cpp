...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V9::RegexTags);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V9::RegexTags);

FLUXION_REGISTER_LOGS_PLUGIN(Fluxion::Plugins::Logs::Text::RegexTags::V9::RegexTags);
...
{
    return "Text::RegexTags::V9";
}

std::string_view RegexTags::GetDirectoryName() const
{
    return "Text_RegexTags_V9";
}
...
{
    return new Fluxion::Plugins::Logs::Text::RegexTags::V9::RegexTags();
}
