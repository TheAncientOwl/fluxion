...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V6::SQLite::ConnectionManager);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V6::SQLite::ConnectionManager);
