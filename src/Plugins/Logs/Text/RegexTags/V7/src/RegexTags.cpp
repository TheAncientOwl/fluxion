...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::RegexTags);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::RegexTags);

FLUXION_REGISTER_LOGS_PLUGIN(Fluxion::Plugins::Logs::Text::RegexTags::V7::RegexTags);
...
{
    auto const output_path{m_home_path / (raw_logs_path.filename().string() + ".scrolls")};
    return output_path;
}
...
{
    return new Fluxion::Plugins::Logs::Text::RegexTags::V7::RegexTags();
}
