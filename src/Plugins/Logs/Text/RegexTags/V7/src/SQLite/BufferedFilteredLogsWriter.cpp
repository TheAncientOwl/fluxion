...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::SQLite::BufferedFilteredLogsWriter);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::SQLite::BufferedFilteredLogsWriter);
