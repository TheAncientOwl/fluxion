...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::SQLite::ConnectionManager);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::SQLite::ConnectionManager);
