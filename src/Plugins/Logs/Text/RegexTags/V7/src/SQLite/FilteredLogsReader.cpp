...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::SQLite::FilteredLogsReader);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V7::SQLite::FilteredLogsReader);
