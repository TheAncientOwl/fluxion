...
class Text_RegexTags_V7_LogsPluginWrapper : public ILogsPluginTestWrapper
{
public:
    /**
...
FLUXION_DEFINE_LOGS_PLUGIN_TESTS(Text_RegexTags_V7_LogsPluginWrapper, {.logs_count = 2000, .seed = 69420});
