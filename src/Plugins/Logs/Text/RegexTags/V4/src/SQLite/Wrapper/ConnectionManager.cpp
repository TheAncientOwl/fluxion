...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::SQLite::ConnectionManager);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::SQLite::ConnectionManager);
