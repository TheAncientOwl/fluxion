...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::SQLite::Utility);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::SQLite::Utility);

namespace Fluxion::Plugins::Logs::Text::RegexTags::V4::SQLite::Utility {
