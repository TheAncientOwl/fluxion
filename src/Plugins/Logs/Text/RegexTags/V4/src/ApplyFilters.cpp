...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::ApplyFilters);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::ApplyFilters);
...
inline bool MatchesFilter(ActiveFilter const& filter, std::vector<std::string> const& row)
{
