...
DEFINE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::RegexTags);
USE_LOG_SCOPE(Fluxion::Plugins::Logs::Text::RegexTags::V4::RegexTags);

FLUXION_REGISTER_LOGS_PLUGIN(Fluxion::Plugins::Logs::Text::RegexTags::V4::RegexTags);
...
{
    return "Text::RegexTags::V4";
}

std::string_view RegexTags::GetDirectoryName() const
{
    return "Text_RegexTags_V4";
}
...
{
    return new Fluxion::Plugins::Logs::Text::RegexTags::V4::RegexTags();
}
