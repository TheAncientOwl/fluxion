...
SettingsManager::SettingsManager(std::filesystem::path home, std::string file_name)
...
void SettingsManager::erase(std::string_view key)
{
...
#define DEFINE_SET_SCALAR(Type)                                              \
    template <>                                                              \
    void SettingsManager::set<Type>(std::string_view key, Type const& value) \
    {                                                                        \
        m_data[key] = value;                                                 \
        Save();                                                              \
    }
...
#define DEFINE_GET_SCALAR(Type, Condition)                               \
    template <>                                                          \
    std::optional<Type> SettingsManager::get<Type>(std::string_view key) \
    {                                                                    \
...
#define DEFINE_SET_VECTOR(Type)                                                                        \
    template <>                                                                                        \
    void SettingsManager::set<std::vector<Type>>(std::string_view key, std::vector<Type> const& value) \
    {                                                                                                  \
        m_data[key] = value;                                                                           \
        Save();                                                                                        \
    }
...
#define DEFINE_GET_VECTOR(Type)                                                                    \
    template <>                                                                                    \
    std::optional<std::vector<Type>> SettingsManager::get<std::vector<Type>>(std::string_view key) \
    {                                                                                              \
