...
namespace Fluxion::Application::Views::Actions::FiltersView {
...
void HandleFiltersViewAction(AppState& application_state, FilterActionPayload const& payload)
{
    ...
    LOG_TRACE("::HandleFiltersViewAction(): type {}", static_cast<std::uint32_t>(payload.type));
    ...
    default: {
        LOG_ERROR(
            "::HandleFiltersViewAction(): Unknown payload type {}",
