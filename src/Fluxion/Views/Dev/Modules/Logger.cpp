...
DEFINE_LOG_SCOPE(Fluxion::Application::Views::Modules::DevView::Logger);
USE_LOG_SCOPE(Fluxion::Application::Views::Modules::DevView::Logger);

namespace Fluxion::Application::Views::Modules::DevView {
                ...
                ImGuiTableFlags_ScrollY | ImGuiTableFlags_ScrollX | ImGuiTableFlags_SizingFixedFit))
    {
        ...
        while (clipper.Step())
        {
            for (int row = clipper.DisplayStart; row < clipper.DisplayEnd; ++row)
            {
                ...
                // Modules::DevView::CPPRenderer::RenderCppSignature(name);
                ...
                //     // Modules::DevView::CPPRenderer::RenderCppSignature(scope);
